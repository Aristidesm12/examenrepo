    ...
    public partial class MainPage : ContentPage
    {
        ...
        private void BtnGuardar_Clicked(object sender, EventArgs e)
        {
         ...
         App.GetInstanceDB.SaveUbicationAsync(new Ubicacion
            ...
            {
                DisplayAlert("CAMPOS VACIOS", "TODOS LOS CAMPOS DEBEN DE LLENARSE", "ACEPTAR");
            }
        }
        ...
        private async void ValidarSalida()
        {
            ...
            {
                bool confirmacion = await DisplayAlert("¿Desea guardar los datos?", "SI INTENTA SALIR SE PERDERAN LOS REGISTROS", "ACEPTAR", "CANCELAR");
                if (confirmacion)
                    await Navigation.PushAsync(new ListaUbicaciones());
            }
        }
